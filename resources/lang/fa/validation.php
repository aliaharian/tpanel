...
return [
    ...
    */
    'attributes' => [
        ...
        "markupPercent"=> "درصد مارک آپ",
        "type"=> "نوع",
        "fromProvince"=>"استان مبدا",
        "fromCity"=> "شهر مبدا",
        "toProvince"=> "استان مقصد",
        "toCity"=> "شهر مقصد",
        "transportCompany"=> "شرکت حمل و نقل",
        "departureDate"=> "تاریخ رفت",
        "departure_date"=> "تاریخ رفت",
        "arrivalDate"=> "تاریخ برگشت",
        "arrival_date"=> "تاریخ برگشت",
        "transportNumber"=> "شماره حمل و نقل",
        "transportClass"=>  "کلاس حمل و نقل",
        "capacity"=> "ظرفیت",
        "adultPrice"=> "قیمت بزرگسال",
        "teenPrice"=> "قیمت نوجوان",
        "kidPrice"=> "قیمت کودک",
        "infantPrice"=> "قیمت نوزاد",
        "buyer_name"=>"نام سرپرست مسافران",
        "national_code"=>  "کد ملی",
        "departure_transport_vehicle"=> "وسیله رفت",
        "arrival_transport_vehicle"=> "وسیله برگشت",
        "hotel_name"=>"نام هتل",
        "family" => "نام خانوادگی",
        "password" => "رمز عبور",
