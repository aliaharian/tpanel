...
export default function HotelServicesList(props) {
    ...
    const handleDeleteService = () => {
        Inertia.delete(route("hotelServices.destroy", selectedService.id));
    };
    const handleEditService = (item) => {
        Inertia.get(route("hotelServices.edit", item.id));
    };
    return (
        <Authenticated
            auth={props.auth}
            ...
            action={
                <a
                    href={route("hotelServices.create")}
