...
export default function WatchersList(props) {
    ...
    const handleViewWatcher = (item) => {
        Inertia.get(route("watchers.show", item.id));
    };
                                                    ...
                                                    (item, index) => (
                                                        ...
                                                        >
                                                            ...
                                                            <td className="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                                ...
                                                                - از تاریخ{" "}
                                                                {timetoJalali(parseInt(item.departure_vehicle?.departure_date_time))}{" "}
                                                                تا تاریخ{" "}
                                                                {timetoJalali(parseInt(item.arrival_vehicle?.departure_date_time))}{" "}
